...
.set    MCPA_INJ_T_MITE,    7          /* Injection time for MITE above Vth measured coarse program = *10us */
...
.set    FPA_INJ_T_MITE,    7          /* Injection time for MITE above Vth fine program = *10us */
