...
.set    INJ_TIME_SP_3,      2000          /* injection time for switch programming (10us) (3rd pulse)*/
.set    INJ_TIME_SP_4,      2000          /* injection time for switch programming (10us) (4th pulse)*/
.set    INJ_TIME_SP_5,      2000          /* injection time for switch programming (10us) (5th pulse)*/
